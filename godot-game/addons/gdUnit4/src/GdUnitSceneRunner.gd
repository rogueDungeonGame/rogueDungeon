...
## [/codeblock]
@abstract func simulate_key_pressed(
...
## [/codeblock]
@abstract func simulate_key_press(
	key_code: int, shift_pressed := false, ctrl_pressed := false
) -> GdUnitSceneRunner
...
@abstract func simulate_key_release(
	key_code: int, shift_pressed := false, ctrl_pressed := false
) -> GdUnitSceneRunner
...
## [/codeblock]
@abstract func simulate_mouse_move_relative(
...
## [/codeblock]
@abstract func simulate_mouse_move_absolute(
...
@abstract func simulate_mouse_button_pressed(
...
## [member button_index] : The mouse button identifier, one of the [enum MouseButton] or button wheel constants.
## [member double_click] : Set to true to simulate a double-click
@abstract func simulate_mouse_button_press(
	button_index: MouseButton, double_click := false
) -> GdUnitSceneRunner
...
@abstract func simulate_screen_touch_pressed(
...
## [member position] : The position to touch the screen.[br]
## [member double_tap] : If true, the touch's state is a double tab.
@abstract func simulate_screen_touch_press(
	index: int, position: Vector2, double_tap := false
) -> GdUnitSceneRunner
...
## [/codeblock]
@abstract func simulate_screen_touch_drag_relative(
	index: int,
	relative: Vector2,
	time: float = 1.0,
...
## [/codeblock]
@abstract func simulate_screen_touch_drag_absolute(
	index: int,
	position: Vector2,
	time: float = 1.0,
	trans_type: Tween.TransitionType = Tween.TRANS_LINEAR
...
## [/codeblock]
@abstract func simulate_screen_touch_drag_drop(
	index: int,
	position: Vector2,
...
@abstract func simulate_until_object_signal(
	source: Object, signal_name: String, ...args: Array
) -> GdUnitSceneRunner
